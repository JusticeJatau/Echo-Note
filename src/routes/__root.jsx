...
export const Route = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Echo8V Notes" },
      { name: "description", content: "Offline-first notes. Fast, simple and yours." },
      { name: "author", content: "Echo8V" },
      { property: "og:title", content: "Echo8V Notes" },
      { property: "og:description", content: "Offline-first notes. Fast, simple and yours." },
