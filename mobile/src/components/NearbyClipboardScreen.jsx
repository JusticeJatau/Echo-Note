...
import {
  ArrowLeft, Check, ClipboardCopy, Copy, Laptop, Link, QrCode, Radio, ScanLine,
  ...
  return (
    <SafeAreaView style={styles.page}>
      <View style={styles.header}>
        <Pressable style={styles.iconButton} onPress={() => navigation.goBack()}><ArrowLeft color={colors.text} size={23} /></Pressable>
        <View style={styles.headerCopy}><Text style={styles.headerTitle}>Clipboard sync</Text><Text style={styles.headerLead}>Private nearby sharing</Text></View>
